...
rule_list(30,:)= [5,1,2,4,1,1];

rule_list(31,:)= [1,2,2,5,1,1];
rule_list(32,:)= [2,2,2,4,1,1];
rule_list(33,:)= [3,2,2,4,1,1];
...
% case theta == ZE 
            %     v,h,t,y,.,.
rule_list(51,:)= [1,1,3,4,1,1];
rule_list(52,:)= [2,1,3,4,1,1];
rule_list(53,:)= [3,1,3,4,1,1];
rule_list(54,:)= [4,1,3,4,1,1];
rule_list(55,:)= [5,1,3,4,1,1];

rule_list(56,:)= [1,2,3,4,1,1];
rule_list(57,:)= [2,2,3,4,1,1];
rule_list(58,:)= [3,2,3,3,1,1];
...
% case theta == PS
            %   v,h,t,y,.,.
rule_list(76,:)= [1,1,4,3,1,1];
rule_list(77,:)= [2,1,4,3,1,1];
rule_list(78,:)= [3,1,4,3,1,1];
rule_list(79,:)= [4,1,4,3,1,1];
rule_list(80,:)= [5,1,4,2,1,1];

rule_list(81,:)= [1,2,4,3,1,1];
rule_list(82,:)= [2,2,4,3,1,1];
rule_list(83,:)= [3,2,4,3,1,1];
rule_list(84,:)= [4,2,4,2,1,1];
rule_list(85,:)= [5,2,4,2,1,1];

rule_list(86,:)= [1,3,4,3,1,1];
